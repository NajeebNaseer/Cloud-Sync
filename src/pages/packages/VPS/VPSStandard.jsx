    ...
    <div className="flex flex-col min-h-screen bg-gray-100">
      ...
      <main className="flex-1 p-8">
        <div className="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-lg">
          <h2 className="text-3xl font-bold text-purple-800 mb-4 text-center">Buy VPS Standard</h2>
          <div className="bg-purple-800 text-white p-4 rounded-lg mb-6 text-center">
            <h3 className="text-2xl font-semibold">VPS Standard Package</h3>
            <p className="text-xl">6 vCPU Cores | 16 GB RAM | 200 GB NVMe or 400 GB SSD | 32 TB Traffic</p>
