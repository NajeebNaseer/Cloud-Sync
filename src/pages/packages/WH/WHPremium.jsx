    ...
    <div className="flex flex-col min-h-screen bg-gray-100">
      ...
      <main className="flex-1 p-8">
        <div className="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-lg">
          <h2 className="text-3xl font-bold text-purple-800 mb-4 text-center">Buy Web Hosting Premium</h2>
          <div className="bg-purple-800 text-white p-4 rounded-lg mb-6 text-center">
            <h3 className="text-2xl font-semibold">Web Hosting Premium Package</h3>
            <p className="text-xl">10 GB Disk Space | 500 GB Bandwidth | 50 Email Accounts</p>
            <p className="text-2xl font-bold">$12.50/ month</p>
          </div>
...
export default WebHostingPremium;
