...
const ConfirmationDetails = ({ user, setform, setSteps }) => {
  ...
  return (
    <div className="max-w-4xl w-full sm:p-8 bg-white shadow-2xl rounded-lg flex justify-around border border-gray-200 sm:space-x-4">
      <div className="flex flex-col justify-center items-center p-8">
        <h2 className="text-2xl font-bold text-[#00c19c] mb-4">Final Step!</h2>
